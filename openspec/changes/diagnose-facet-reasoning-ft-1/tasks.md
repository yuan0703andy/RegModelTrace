...
- [x] Record immutable hashes for the closed release and DCC historical inputs.
...
- [ ] Compare A/B/C and make the FT-1 authorization decision.
- [ ] Close the research change without training, or write a separate Condition D proposal if justified.
