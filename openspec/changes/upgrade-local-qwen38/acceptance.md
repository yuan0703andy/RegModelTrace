...
- A pending GPU allocation permits only a configuration-level switch. Runtime
  readiness remains unverified until the smoke passes, and deployment claims
  fail closed before then.
