...
- Discovery protocol is frozen before screening; it defines documents, scope, queries, deduplication, cap, and stopping condition for each panel.
- Every generated lead has deterministic discovery provenance and an exposure status; unknown exposure is not treated as eligible.
