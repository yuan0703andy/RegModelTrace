...
- [x] Freeze the keep/remove manifest before destructive cleanup.
- [x] Stage the compact release outside the working tree.
- [x] Replace the working tree and remove unreachable Git objects.
